...
import org.fac.jmonkey.charge.Charge;
import org.fac.jmonkey.creep.CreepControl;
import org.fac.jmonkey.game.GamePlayAppState;
...
public class TowerControl extends AbstractControl implements Savable, Cloneable {
    ...
    @SuppressWarnings("unused")
    private static final Logger logger = LogManager.getLogger(TowerControl.class);
